...
<body>
	...
	<div class="section">
		<div class="container">
			...
			<div class="box">
				...
				?>
					<a href="merek.php?kat=<?php echo $k['category_id'] ?>">
						<div class="col-5">
							<img src="img/icon kategori.jpg" width="35px" style="margin-bottom: 5px;">
							<p><?php echo $k['category_name'] ?></p>
						</div>
					</a>
				<?php }}else{ ?>
					<p>Yang anda cari tidak ada</p>
				<?php } ?>
			</div>
		</div>
	</div>
	...
	<div class="section">
		<div class="container">
			...
			<div class="box">
				<?php 
					$merek = mysqli_query($conn, "SELECT * FROM tb_product WHERE product_status = 1 ORDER BY product_id DESC LIMIT 8");
