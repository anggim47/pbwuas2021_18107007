		...
		<div class="container">
			...
			<div class="box">
				<form action="" method="POST" enctype="multipart/form-data">
					...
					<input type="text" name="nama" class="input-control" placeholder="Nama Merek" value="<?php echo $p->product_name ?>" required>
				...
				<?php 
					if(isset($_POST['submit'])){
						...
						if($update){
							echo '<script>alert("Ubah data mantap berhasil bro")</script>';
							echo '<script>window.location="data-merek.php"</script>';
						}else{
